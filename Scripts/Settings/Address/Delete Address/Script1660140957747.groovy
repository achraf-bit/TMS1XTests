...
WebUI.setText(findTestObject('Settings/Address Settings/input_Search'), '1234')

WebUI.click(findTestObject('Settings/Address Settings/button_Delete'))

WebUI.click(findTestObject('Settings/Address Settings/button_Yes'))
