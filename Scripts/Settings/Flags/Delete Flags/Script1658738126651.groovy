...
WebUI.setText(findTestObject('Settings/Flags Page/input_search'), 'R2')

WebUI.click(findTestObject('Settings/Flags Page/button_Delete'))

WebUI.click(findTestObject('Settings/Flags Page/button_Yes'))
