...
WebUI.click(findTestObject('Settings/Flags Page/button_Add_Flags'))

WebUI.setText(findTestObject('Settings/Flags Page/input_Reference'), 'R1')

WebUI.setText(findTestObject('Settings/Flags Page/input_Name'), 'test')

WebUI.click(findTestObject('Settings/Flags Page/button_Select_icon'))
...
WebUI.click(findTestObject('Settings/Flags Page/button_Add'))
